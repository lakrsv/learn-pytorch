...
class LitAutoEncoder(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        validation_in = x.reshape(-1, 1, 28, 28)
        validation_out = x_hat.reshape(-1, 1, 28, 28)
        validation_imgs = torch.cat([validation_in, validation_out])

        self.logger.experiment.add_images("validation_img", validation_imgs, self.global_step)
...
checkpoint_dir = '../../models/train_model_visualize/'
batch_size = 64
max_epochs = 1000
